...
function _draw_game()
 ...
 local s=32
 spr(2,player.ox,player.oy,1,1,facing>0)
...
function print_float(msg)
 if msg[2]==0 then
  ...
  msg[2]-=msg[6]
  print(msg[1],x+5-#msg[1]*2,y-9+msg[2]/2,1)
  print(msg[1],x+4-#msg[1]*2,y-10+msg[2]/2,msg[3])
  return true
 end
end
-->8
...
000e00000a6500465001600116002e650286002e600386001860019600376001b6001d6001e600216002260024600296002a6002d6002f600306000b600096000a60000600006000060000600006000060000600
