...
function _draw_game()
 ...
 for e in all(entities) do
  if(is_visible(e.x,e.y,false)) spr(e.sprnb+get_sprite_delta(e),8*e.x,8*e.y-2,1,1,e.x<=player.x)
 end
 
  -- unseen barrels
 for b in all(barrels) do
  if(is_visible(b.x,b.y,false)) spr(b.sprnb,8*b.x,8*b.y-2)
 end
 ...
 for i=i0,i1 do
  ...
  for j=-l,l do
   ...
   if is_visible(x2,y2,false) then
    ...
    if(i==0 and j==0) spr(2,player.ox,player.oy,1,1,facing>0)
    for e in all(entities) do
     if(e.x==x2 and e.y==y2) then
      spr(2,e.ox,e.oy,1,1,e.x<=player.x)
     end
    end
    ...
    for b in all(barrels) do
     if(b.x==x2 and b.y==y2) spr(b.sprnb,8*b.x,8*b.y-2)
    end
   end
  end
 end
...
function make_medkit(x,y)
 add(floor_weapons,{x=x,y=y,hp=50,sprnb=87,ent=6})
end

-- x,y: pos
-- arm: arm gain
function make_armor(x,y)
 add(floor_weapons,{x=x,y=y,sprnb=3,ent=7,arm=50})
end
...
__gfx__

...
eee8882ee22222ee8882ee8882eeeeeeeee8882eee8882eeeeeeeeeee77777eeeeeeeeeeeeeeeeeeeeeeeeee0000000000000000000000000000000000000000
...

...

__sfx__
010500000c2332f253152330621302203092030620304203002030020300203002030020300203002030020300203002030020300203002030020300203002030020300203002030020300203002030020309200
